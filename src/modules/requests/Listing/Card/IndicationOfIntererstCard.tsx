...
import { IIndicationOfInterestRequestPaginated, IInterestedPerson } from "@/types";
...
interface IProps
  ...
  data: IIndicationOfInterestRequestPaginated;
}

export default function IndicationOfIntererstCard(props: IProps) {
