...
import { ISupportRequestPaginated } from "@/types";
...
interface IProps
  ...
  data: ISupportRequestPaginated;
}

export default function SupportCard(props: IProps) {
  const { data: request, ...rest } = props;
  const data = RequestHelper.getSupportRequestData(request)
